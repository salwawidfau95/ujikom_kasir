...
<main class="flex-1 p-8 ml-4">
    ...
    <div class="bg-white p-8 shadow-md rounded-lg mt-6">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('transactions.create') }}" class="px-5 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center space-x-2">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mt-6 mb-4 gap-4">
            ...
            <div class="flex items-center flex-wrap gap-3 text-sm">
                <form method="GET" action="{{ route('transactions.index2') }}" class="flex items-center space-x-4">
                    ...
                    <select id="entries" name="entries" class="border rounded px-2 py-1 text-sm" onchange="this.form.submit()">
                ...
                @foreach ($transactions as $transaction)
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="py-3 px-2 flex justify-center space-x-2">
                            ...
                            <a href="{{ route('transactions.receipt2', $transaction->id) }}" class="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600 text-sm">
                                Download Proof
                            </a>
                        </td>
                    </tr>
